...
public class click002 : MonoBehaviour
{
    ...
    void init()
    {
        ...
        janken = new UnityJankenSettai(5);
        showResult();
    ...
    protected void _game(int player_hand_no)
    {
        ...
        string[] msg = new string[] { "YOU WIN", "DRAW", "YOU LOSE" };
...
/*
    public IEnumerator jsonPost()
    {
        ...
        var url = "http://localhost:3000/users/connectionSettai/" + uid;
...
*/
    ...
    {
        string[] msg = new string[] { "settai_win", "settai_draw", "settai_lose" };
